...
SELECT 
    ...
    job_posted_date, job_no_degree_mention, job_health_insurance, 
    job_country, salary_rate, salary_year_avg, salary_hour_avg
FROM read_csv('dataset/job_postings_fact.csv', 
    AUTO_DETECT=true,
    HEADER=true);
...
FROM read_csv('dataset/skills_job_dim.csv', 
    AUTO_DETECT=true,
    HEADER=true);
